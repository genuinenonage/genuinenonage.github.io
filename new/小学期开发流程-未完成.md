...
* 顶级菜单
	* parent_id = 0 没有父级
	* permission_level=1 权限等级是1
	* permission_url=null 没有权限url
	* permission_name=对应的名字
* 子级菜单
	* parent_id=对应的父级的ID
	* permission_level=2 权限等级是2
	* permission_url 对应的url
	* permission_name 对应的名字
...
需求： md5加密的密码 会被cmd5还原，所以需要修改，课程结束会提问。